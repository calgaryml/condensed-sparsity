...
#     def __init__(self, diet, num_blocks, num_classes=10):
#         super(ResNet, self).__init__()
#         # self.in_planes = 64
#         self.diet = diet
#         self.conv1 = nn.Conv2d(
#             3, self.diet[0], kernel_size=3, stride=1, padding=1, bias=False
#         )
#         self.bn1 = nn.BatchNorm2d(self.diet[0])
...
def get_skinny_resnet18(diet: List[int]):
    return SkinnyResNet18(diet, num_blocks=[2, 2, 2, 2])
